...
(function installBGHud() {
    ...
    function activateDiagnostics(auto = false) {
        ...
        try { window.visaion_OVERLAY_TRACE = true; window.FORCE_POSE_DRAW = true; window.ARC_TRIM_TOP = false; } catch { }
    ...
    function deactivateDiagnostics() {
        ...
        diagStepLoopStop();
        try { window.visaion_OVERLAY_TRACE = false; window.FORCE_POSE_DRAW = false; } catch { }
    ...
    bind('overlay-debug', () => { try { window.setOverlayMode?.('debug'); window.visaion_OVERLAY_TRACE = true; } catch { } });
